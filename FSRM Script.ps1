function Install-FSRMRansomware {
    ...
    #>
#Email information is at line 4492 currently. 
#Parameters I do not know if they work.
        ...
        Process{
                ...
                #To Update Extentions https://fsrm.experiant.ca/api/v1/get Current is 4347 Extentions
                New-FsrmFileGroup -name "Ransomware Files" -IncludePattern @( 
                            ...
                            "*.59d49",
                            "*.Horriblemorning",
                            "*.support@anonymous-service.cc.ppdddpnUnusual",
                            "*.SaveTheQueenING",
                            ...
                            "*.id[*-2242].[Keu2026",
                            "*.id[*-2275",
                            "*.id[*-2275].[supportcrypt2019@cocku2026",
                            ...
                            "*.aa1",
                            "*.zoro",
                            "u0418u043du0441u0442u0440u0443u043au0446u0438u044f u043fu043e u0440u0430u0441u0448u0438u0444u0440u043eu0432u043au0435.TXT",
                            "*.kes",
                            "*.condat",
                            "*.dotmap",
                            "*.4k",
                            ...
                            "*.suffer",
                            "*.u0438u043du0441u0442u0440u0443u043au0446u0438u044f u043fu043e u043eu043fu043bu0430u0442u0435.txt",
                            "*.metan",
                            "*.kezoz",
                            "*.luces",
                            "*.doples",
                            ...
                            "_u5982u4f55u89e3u5bc6u6211u7684u6587u4ef6_.txt",
                            "How to decrypt.txt",
                            ...
                            "! u041fu0420u041eu0427u0422u0418 u041cu0415u041du042f !.html",
                            "*.cammora",
                            "*.SBLOCK",
                            "*.promoz",
                            "*.crazy",
                            ...
                            "*.ryx",
                            "*.[ti_kozel@lashbania.tv].u043au043eu0441u0442u044f",
                            "*.nostro",
                            ...
                            "*.ducueyuav",
                            "*.oslawcmme",
                            "*.u0417u0430u0449u0438u0449u0435u043du043e",
                            "*.Djvuu",
                            "*.PRCP",
                            ...
                            "*.justice",
                            "*.adam",
                            "*...Files-Frozen-NEED-TO-MAKE-PAYMENTu2026",
                            ...
                            "*.EV",
                            "*.lokitus",
                            "*.lukitus-tiedostopu00e4u00e4tettu00e4",
                            "*.fmoon",
                            "*.cesar",
                            "*.lukitus",
                            "*.KK",
                            ...
                            "*.whycry",
                            "!READ.htm",
                            "!_u0418u041du0421u0422u0420u0423u041au0426u0418u042f_!.txt",
                            "*.cr020801",
                            "*.cerber6",
                            "*.netn6",
                            "*.rnsmwre",
                            ...
                            "*.RMCM1",
                            "*.Locked-by-Mafia",
                            "*.u043au0438u0431u0435u0440 u0440u0430u0437u0432u0435u0442u0432u0438u0442u0435u043bu044c",
                            "*-filesencrypted.html",
                            "decrypt_Globe*.exe",
                            "*.hnumkhotep",
                            "DecryptFile.txt",
                            ...
                            "*.zzzzz",
                            "xort.txt",
                            "DOSYALARINIZA ULAu015eMAK u0130u00c7u0130N Au00c7INIZ.html",
                            ...
                            "Comment du00e9bloquer mes fichiers.txt",
                            "BUYUNLOCKCODE.txt",
...
"@
            ...
            $DenyPermissionsScript | Out-File -FilePath "C:\scripts\ScriptToDenyPermissions.PS1"
            #unwblocks the script to allo for execution 
            Unblock-file "C:\scripts\ScriptToDenyPermissions.PS1"
...
# EmailTo can be changed to the email that will receive the email.
# EmailFrom is the from address 
# SMTPServer can be changed to the email server that your email account will use.
# At this point the emailing part does not work to my knowledge.
Install-FSRMRansomware -SMTPServer "smtp.office365.com" -EmailTo "EmailTo@email.com" -EmailFrom "EmailFrom@email.com"
# Installing Python for Emailing add the Trusted switch
...
Move-Item -Path "C:\FSRM\Email.py" -Destination "C:\scripts\"